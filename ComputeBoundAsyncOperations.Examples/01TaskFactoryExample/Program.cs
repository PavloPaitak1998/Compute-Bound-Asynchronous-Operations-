...
namespace _01TaskFactoryExample
{
    class Program
    {
        static void Main(string[] args)
        {
            Task parent = new Task(() =>
            {
                ...
                var childTasks = new[]
                {
                    ...
                    tf.StartNew(() => Sum(cts.Token, Int32.MaxValue), cts.Token) // Too big, throws OverflowException
                };

                // If any of the child tasks throw Exception, cancel the rest of them
            ...
            Console.WriteLine("Please enter sth to finish.");
            Console.ReadLine();
        }
